...
- **UiPath Orchestrator API** — Integrated via custom backend (`uipath_client.py`) to fetch available processes and securely trigger automated reporting/remediation tasks.
...
└──────┬───────────────┬──────────────────┬───────────┘
       │               │                  │
┌──────▼──────┐ ┌──────▼──────┐ ┌────────▼────────┐
│   Supabase  │ │ Gemini 2.5  │ │     UiPath      │
│  Database   │ │  + Groq LLM │ │  Orchestrator   │
└─────────────┘ └─────────────┘ └─────────────────┘
```
...
| Condition | Points |
|---|---|
| Amount > Rp 1 billion | +50 |
| Amount > Rp 500 million | +30 |
| Suspicious vendor name | +30 |
| Missing invoice ID | +20 |
...
AI Engineer & Mobile Application Developer — West Java, Indonesia
